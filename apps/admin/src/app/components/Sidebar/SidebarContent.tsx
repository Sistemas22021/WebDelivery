    ...
    return (
        <div className="w-80 h-full bg-white lg:border-e-2 border-gray-200">
            ...
            {/* Sidebar content here */}
                <li>
                    <SidebarLink observer_id="link-1" order_status={OrderStatus.PENDING} setOrderStatus={props.setOrderStatus} key='link-1'   href='#' icon={faBell} text='Pendientes'/>
                </li>
                <li>
                    <SidebarLink observer_id="link-2" order_status={OrderStatus.ON_PROGRESS} setOrderStatus={props.setOrderStatus}  key='link-2'  href='#' icon={faListUl} text='En Progreso' />
                </li>
            </ul>
        </div>
    );
